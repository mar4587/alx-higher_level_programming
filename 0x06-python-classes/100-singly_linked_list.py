...
"""This function is a module for a singly linked list"""
...
class Node:
    ...
    @property
    def data(self):
        """This gets a data attribute"""

        return (self.__data)

    @data.setter
    def data(self, value):
        """This sets a data attribute"""
    ...
    @property
    def next_node(self):
        """This gets the next_node attribute
        Returns: next node
        """
...
class SinglyLinkedList:
    ...
    def __str__(self):
        """This function makes the lists printable"""
