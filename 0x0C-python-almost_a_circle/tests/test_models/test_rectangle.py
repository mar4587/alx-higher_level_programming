#!/usr/bin/python3
"""This class defines unittests for
models/rectangle.py
...
class TestRectangle_instantiation(unittest.TestCase):
    """This class unittests for testing instantiation
    of the
    Rectangle class."""
...
class TestRectangle_width(unittest.TestCase):
    """This class unittests for testing initialization
    of
...
class TestRectangle_height(unittest.TestCase):
    """This uclass unittests for testing initialization
    of Rectangle
    height attribute."""
...
class TestRectangle_x(unittest.TestCase):
    """This class unittests for testing
    initialization of
...
class TestRectangle_order_of_initialization(unittest.TestCase):
    """This class unittests for testing Rectangle order of
    attribute
    initialization."""
...
class TestRectangle_update_args(unittest.TestCase):
    """This class unittests for testing update args
    method of the
    Rectangle class."""
...
class TestRectangle_update_kwargs(unittest.TestCase):
    """This class unittests for testing update kwargs
    method of
    the Rectangle class."""
