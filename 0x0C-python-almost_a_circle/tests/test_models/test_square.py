...
class TestSquare_size(unittest.TestCase):
    """This class unittests for testing size
    initialization of
    the Square class."""
...
class TestSquare_order_of_initialization(unittest.TestCase):
    """This class unittests for testing order of
    Square attribute
    initialization."""
...
class TestSquare_area(unittest.TestCase):
    """This unittests for testing the area method
    of the Square class."""
...
class TestSquare_stdout(unittest.TestCase):
    """This class unittests for testing __str__ and
    display methods of
    Square class."""

    @staticmethod
    def capture_stdout(sq, method):
        """This captures and returns text
        printed to stdout.
...
class TestSquare_update_args(unittest.TestCase):
    """This class unittests for testing update
    args method of the
    Square class."""
